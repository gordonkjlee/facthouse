/**
 * Run the first-fact eval and fail if there was nothing to run it against.
 *
...
const child = spawn(
  ...
  [
    ...
    "run",
    "tests/integration/first-fact.test.ts",
    "--reporter=verbose",
  ],
  {
    stdio: "inherit",
    env: { ...process.env, OPENMEMORY_REQUIRE_FIRST_FACT_EVAL: "1" },
  },
);
