...
import { domainPromptGuide, ROUTABLE_DOMAIN_NAMES } from "../schemas/domains.js";
        ...
        async () => {
          ...
          const raw = await ask(
            "You extract durable facts about the user from a conversation. " +
              ...
              `domain_hint is one of ${ROUTABLE_DOMAIN_NAMES.join("|")} or null. ` +
