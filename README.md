...
```bash
npm install -g @factmem/mcp@0.23.0
factmem init
```
...
```bash
npx -y -p @factmem/mcp@0.23.0 -- factmem init
```
<!-- x-release-please-end -->
...
om() { npx -y -p @factmem/mcp@0.23.0 -- factmem "$@"; }
om init --yes
```
...
function om { npx -y -p "@factmem/mcp@0.23.0" -- factmem @args }
om init --yes
```
<!-- x-release-please-end -->
